...
<div class="cd-schedule loading">
	...
	<div class="events">
		<ul>
			<li class="events-group">
				...
				<ul>
					<li class="single-event" data-start="09:30" data-end="10:30" data-content="HELLO THIS IS THE CONTENTS" data-event="event-1">
						<a href="#0">
	...
	<div class="event-modal">
		...
		<div class="body">
			<div class="event-info" style="padding: 30px; width: 420px;">HELLO THIS IS THE CONTENT WITH THE PATIENT INFORMATION</div>
