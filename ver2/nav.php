<!-- NAVIGATION BAR FOR DOCTOR DASHBOARD -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                <li>
                    <a href="index.php"><i class="fa fa-dashboard fa-fw"></i> Bookings</a>
                </li>
                <li>
                    <a href="schedule.php"><i class="fa fa-table fa-fw"></i> Schedule</a>
                </li>
                <li>
                    <a href="login.php?logstat=1"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                </li>
            </ul>
        </div>
    </div>
