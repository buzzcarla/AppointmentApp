						...
						<div class="row">
							<div class="col-lg-12">
								<div class="strip_list wow fadeIn">';
									...
									echo '<p>'.$row[28].'</p>
									<p><strong>Clinic Hours:</strong> '.$row[18].' - '.$row[19].'</p>
									<ul>
										...
										<li><a href="detail-page-2.ph	p?docid='.$row[11].'&userid='.$uid.'&clinname='.$row[22].'&clinadd='.$row[25].'&docfname='.$row[1].'&docmname='.$row[2].'&doclname='.$row[3].'&start='.$row[18].'&end='.$row[19].'&mobile='.$row[8].'&tele='.$row[9].'&profpic='.$row[17].'&specialization='.$row[14].'">Book This Doctor</a></li>
									</ul>
								</div>
							</div>
						</div>
