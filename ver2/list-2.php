								...
								<div class="row">
									<div class="col-lg-12">
										...
										<a href="#0" class="wish_bt"></a>
											...
											<li><a href="detail-page-2.php?docid='.$row[8].'&userid='.$uid.'&clinname='.$row[1].'&clinadd='.$row[4].'&docfname='.$row[19].'&docmname='.$row[20].'&doclname='.$row[21].'&start='.$row[9].'&end='.$row[10].'&mobile='.$row[26].'&tele='.$row[27].'&profpic='.$row[17].'&specialization='.$row[14].'&permitnum='.$row[5].'">Book This Doctor</a></li>
											</ul> 
										</div>
									</div>
							</div>
						...
						if(mysqli_num_rows($res)>0){
							...
							while($row = mysqli_fetch_array($res)) {
								...
								echo '<ul>
										<li><a href="#0" onclick="onHtmlClick("Doctors", 2)" class="btn_listing">View on Map</a></li>
										<li><a href="https://www.google.com/maps/dir//Assistance+%E2%80%93+H%C3%B4pitaux+De+Paris,+3+Avenue+Victoria,+75004+Paris,+Francia/@48.8606548,2.3348734,14z/data=!4m15!1m6!3m5!1s0x0:0xa6a9af76b1e2d899!2sAssistance+%E2%80%93+H%C3%B4pitaux+De+Paris!8m2!3d48.8568376!4d2.3504305!4m7!1m0!1m5!1m1!1s0x47e67031f8c20147:0xa6a9af76b1e2d899!2m2!1d2.3504327!2d48.8568361" target="_blank">Directions</a></li>
										<li><a href="detail-page-2.php?docid='.$row[12].'&userid='.$uid.'&clinname='.$row[22].'&clinadd='.$row[25].'&docfname='.$row[1].'&docmname='.$row[2].'&doclname='.$row[3].'&start='.$row[18].'&end='.$row[19].'&mobile='.$row[8].'&tele='.$row[9].'&profpic='.$row[17].'&specialization='.$row[14].'&permitnum='.$row[29].'">Book This Doctor</a></li>
									</ul> </div>
									</div>
								</div>
								</div>';
